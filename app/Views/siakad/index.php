        ...
        <div class="col-12">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Data Mahasiswa (Siakad)</h6>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="needs-validation" action="/siakad/save/" method="POST" novalidate="">
    ...
    <div class="modal fade" id="updateModal<?= $d['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Data</h5>
                    <a type="button" style="color: black;" data-bs-dismiss="modal" href="/siakad/index/" class="close" aria-label="Close">X</a>

                </div>
                <div class="modal-body">
                    <?= form_open('siakad/update/' . $d['id']); ?>
                    <?= csrf_field(); ?>
                    ...
                    <div class="card-footer text-right">
                        ...
                        <a href="/siakad/index" class="btn btn-danger btn-sm"> Batal</a>
                    </div>
                    <?= form_close(); ?>
                </div>
            </div>
